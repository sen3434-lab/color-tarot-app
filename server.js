...
- "reading" 필드는 한 덩어리로 붙여쓰지 말고, 아래 3부분으로 나누어 각 부분 사이에 줄바꿈 두 번(\n\n)을 넣어 문단을 분리하세요: (1) 감정에 대한 공감 1~2문장 (2) 카드의 색이 지금 상황에 어떤 의미인지 2~3문장 (3) 희망적인 격려 1~2문장. 각 문단은 그 자체로 짧고 읽기 편해야 합니다.
- 반드시 아래 JSON 형식으로만 답하세요. 다른 텍스트를 덧붙이지 마세요.

{
  "reading": "3개 문단(공감 / 카드 해석 / 격려)을 \\n\\n으로 구분한 텍스트",
